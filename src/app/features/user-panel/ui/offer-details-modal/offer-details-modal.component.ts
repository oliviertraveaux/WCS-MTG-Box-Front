...
} from '../../../transaction/offer/components/card-ad-offer/card-ad-offer-desktop/card-ad-offer-desktop.component';
import {
  CardAdOfferMobileComponent
} from '../../../transaction/offer/components/card-ad-offer/card-ad-offer-mobile/card-ad-offer-mobile.component';
...
export class OfferDetailsModalComponent {
  private readonly dialogRef = inject(MatDialogRef<OfferDetailsModalComponent>)
